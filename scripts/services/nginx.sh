...
EOF
    ...
    # Copy and process Fooocus redirect page template
    echo "nginx: creating smart Fooocus redirect page from template"
    cp /opt/templates/fooocus.html /opt/nginx/html/fooocus.html
